...
VALIDATION_TARGETS = [
    ...
    {
        "name": "Compute Access Royalty Link",
        "schema": ROOT / "schemas" / "compute-access-royalty-link.schema.json",
        "example": ROOT / "examples" / "compute-access-royalty-link.example.yaml",
    },
]
